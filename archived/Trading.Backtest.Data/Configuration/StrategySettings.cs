namespace Trading.Backtest.Data.Configuration;
...
public class StrategySettings
{
    ...
    public StrategyConfig ToStrategyConfig(string strategyName, int baseEma, int atrPeriod)
    {
        ...
        return new StrategyConfig
        {
            ...
            AdxPeriod = AdxPeriod,
            AdxTimeframe = Enum.TryParse<AdxTimeframe>(AdxTimeframe, out var timeframe) ? timeframe : Trading.Models.AdxTimeframe.Current,

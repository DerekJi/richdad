...
using Trading.Strategy.Analyzer.Backtest.Engine;
using Trading.Core.Strategies;
using Trading.Backtest.Data.Interfaces;
using Trading.Models;
using Trading.Backtest.Data.Providers;
using Trading.Backtest.Data.Configuration;

namespace Trading.Strategy.Analyzer.Backtest.Services;

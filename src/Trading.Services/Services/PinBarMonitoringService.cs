...
public class PinBarMonitoringService : BackgroundService
{
        ...
        if (_aiAnalysisService != null)
        {
            try
            {
                ...
                var tradeDirection = direction == "Long"
                    ? Trading.Models.TradeDirection.Long
                    : Trading.Models.TradeDirection.Short;
    ...
    {
        var config = new Trading.Models.StrategyConfig
        {
            ...
            StopLossStrategy = settings.StopLossStrategy == "PinbarEndPlusAtr"
                ? Trading.Models.StopLossStrategy.PinbarEndPlusAtr
                : Trading.Models.StopLossStrategy.PinbarEndPlusAtr,
...
• 收盘: {pinBarCandle.Close:F5}";
        ...
        if (aiValidation != null)
        {
            ...
            {
                Trading.Infrastructure.AI.Models.RiskLevel.Low => "🟢",
                Trading.Infrastructure.AI.Models.RiskLevel.Medium => "🟡",
                Trading.Infrastructure.AI.Models.RiskLevel.High => "🔴",
                _ => "⚪"
            };
